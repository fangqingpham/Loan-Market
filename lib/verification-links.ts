...
export const PROVINCE_VERIFICATION_LINKS: ProvinceVerification[] = [
  {
    ...
    mortgage: { label: "Real Estate Council of Alberta (RECA)", href: "https://www.reca.ca/find-a-professional-or-brokerage/" },
  },
  {
    ...
    mortgage: { label: "BCFSA \u2014 check licences", href: "https://www.bcfsa.ca/public-resources/check-licences-registrations" },
  },
  {
    name: "Manitoba",
  ...
  },
  {
    ...
    mortgage: { label: "FCNB \u2014 check registration", href: "https://www.fcnb.ca/en/check-registration" },
  },
  {
    ...
    mortgage: { label: "Digital Government and Service NL", href: "https://www.gov.nl.ca/dgsnl/" },
  },
  {
    ...
    corporate: CBR,
    lenderLicence: null,
    mortgage: { label: "mortgageregulators.ca", href: "https://mortgageregulators.ca/" },
  },
  {
    name: "Nova Scotia",
    ...
    corporate: CBR,
    lenderLicence: null,
    mortgage: { label: "Service Nova Scotia \u2014 mortgage regulation", href: "https://beta.novascotia.ca/programs-and-services/mortgage-regulation" },
  },
  {
    name: "Nunavut",
    creditUnion: null,
  ...
  },
  {
    ...
    mortgage: { label: "AMF \u2014 registers", href: "https://lautorite.qc.ca/en/general-public/registers" },
  },
  {
    name: "Saskatchewan",
    ...
    mortgage: { label: "FCAA Saskatchewan", href: "https://fcaa.gov.sk.ca/" },
  },
  {
    name: "Yukon",
    creditUnion: null,
